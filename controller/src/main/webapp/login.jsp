...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form action="<%=request.getContextPath()%>/login.admin" method="post" class="layui-form" >
            ...
            <a href="javascript:;" onclick="document.getElementById('img').src='<%=request.getContextPath()%>/checkcode?'+(new Date()).getTime()">
                <img id="img" style="background-color: #0C0C0C;width: 150px;height: 50px;margin-left: 50px;float:left" src="<%=request.getContextPath()%>/checkcode" alt="点击刷新验证码">
            </a>
